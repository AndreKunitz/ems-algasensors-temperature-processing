package com.akunitz.algasensors.temperature.processing.api.controller;

import com.akunitz.algasensors.temperature.processing.api.model.TemperatureLogOutput;
...
import static com.akunitz.algasensors.temperature.processing.infrastructure.rabbitmq.RabbitMQConfig.FANOUT_EXCHANGE_NAME;
...
public class TemperatureProcessingController {
    ...
    public void data(@PathVariable("sensorId") TSID sensorId, @RequestBody String input) {
        ...
        try {
            temperature = Double.parseDouble(input.trim());
